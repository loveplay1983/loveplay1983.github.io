...
$$D_KL(P || Q) = ∑_i P(i) log \bigg[\frac{P(i)}{Q(i)}\bigg]$$

where P and Q are probability distributions over the same set of events, and P(i) and Q(i) are the probabilities of the ith event in the distributions.

Let's break down the formula:

- $$D_KL(P || Q)$$: This is the KL divergence between P and Q, which measures how different Q is from P.
...
# Why Cross Entropy is Negative
https://www.theochem.ru.nl/~pwormer/Knowino/knowino.org/wiki/Logarithm.html#:~:text=Thus%2C%20for%20any%20base%20b,seen%20in%20the%20image%20below.

> Thus, for any base _b_ > 1 logarithms of numbers between 0 and 1 are negative numbers, the logarithm of 1 is 0, and logarithms of numbers greater than 1 are positive real numbers as seen in the image below.
